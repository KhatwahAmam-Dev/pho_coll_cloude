...
/* ============================================================
   ...
   ============================================================ */
const CONFIG = {
  STORE_NAME: 'Nama Toko',          // tampil di header collage
  SCRIPT_URL: '',                   // URL Web App Apps Script. Kosong = mode demo (tanpa cloud)
  API_KEY: 'ganti-dengan-kode-rahasia', // harus sama dengan API_KEY di Code.gs
  DEMO_USERS: { demo: '1234' },     // hanya dipakai saat SCRIPT_URL kosong
  PHOTO_W: 960,                     // lebar foto hasil (tinggi otomatis 4:3 potret)
  JPEG_Q: 0.78,
  // GPS. Angka akurasi dari browser = radius dalam meter (tingkat kepercayaan 95% menurut spesifikasi).
  GPS_TARGET_M: 30,                 // target akurasi: makin kecil makin ketat
  GPS_WAJIB: false,                 // true = tombol foto ditolak selama akurasi belum mencapai target
